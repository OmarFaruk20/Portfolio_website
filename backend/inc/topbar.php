                    ...
                    <nav class="navbar-custom">
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <?php
                                ...
                                $select = "SELECT count(id) FROM contact where status='1'";
                                ...
                                if ($query==true) {
                                   ...
                                   aria-haspopup="false" aria-expanded="false">
                                    ...
                                    <span class="badge badge-custom badge-pill noti-icon-badge"><?php echo $run['count(id)']?></span>
                                </a>
                                         <?php
                                     }
                                 } 
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="assets/images/users/avatar-3.jpg" alt="user" class="rounded-circle"> <span class="ml-1">Maxine K <i class="mdi mdi-chevron-down"></i> </span>
                                </a>
